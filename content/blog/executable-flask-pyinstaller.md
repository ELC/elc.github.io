...
If you just want to read the solution, scroll down to the solution section or clic [here](#solution)
...
- Hey! I built some amazing piece of software!
+ Really?! Send me a copy so I could check it out
- Sure! Just extract the file in your email and execute the file inside
