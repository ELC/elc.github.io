const version = "1ae4c0a";
const currentCacheName = `ELCWEB-${version}`;
const filesToCache = [
    "/?v=d901fb9",
    "/about/?v=0d1a701",
    "/archives/?v=5de278f",
    "/author/ezequiel-leonardo-castano/?v=ae2ee68",
    "/author/ezequiel-leonardo-castano/page/2/?v=327a7e4",
    "/authors/?v=0aa43fd",
    ...
    "/drafts/functional-python.html?v=26330ed",
    ...
    "/posts/embed-interactive-notebooks/?v=e20fb55",
    "/posts/executable-flask-pyinstaller/?v=22a94a9",
    "/posts/fastai-colab-deep-learning/?v=9356a75",
    "/posts/git-guide-with-visual-interface/?v=a08cb8a",
    "/posts/git-guide-with-visual-interface/es/?v=353a541",
    "/posts/haskell-pattern-matching-in-python/?v=63d4994",
    ...
    "/posts/ordinary-differential-equations-with-python/?v=be7dc63",
    "/posts/pascal-triangle-vs-genetic-algorithm/?v=fbf37fe",
    "/posts/plotting-fractals-step-by-step-with-python/?v=781204f",
    "/posts/plotting-fractals-step-by-step-with-python/es/?v=f224495",
    "/posts/streamlit-google-analytics/?v=95caecf",
    "/posts/streamlit-lessons/?v=3b8c34d",
    "/posts/streamlit-multipage/?v=c5094c1",
    "/posts/times-tables/?v=c8aded8",
    "/projects/?v=f9a673e",
    ...
    "/tag/functional-programming/?v=87d022d",
    "/tag/games/?v=0149fb2",
    "/tag/git/?v=5198ff2",
    ...
    "/tag/python/?v=850023a",
    "/tag/python/page/2/?v=03e7f64",
    "/tag/scipy/?v=938e42d",
