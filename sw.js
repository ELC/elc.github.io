const version = "73e102d";
const currentCacheName = `ELCWEB-${version}`;
const filesToCache = [
    "/?v=306f461",
    "/about/?v=dc9d217",
    "/archives/?v=bd22db0",
    "/author/ezequiel-leonardo-castano/?v=2da5148",
    ...
    "/category/programming/?v=de85c18",
    ...
    "/feeds/all-en.atom.xml?v=224fbcb",
    "/feeds/all-es.atom.xml?v=1d8b0a5",
    "/feeds/all.atom.xml?v=0445d07",
    "/feeds/ezequiel-leonardo-castano.atom.xml?v=317e932",
    "/feeds/ezequiel-leonardo-castano.rss.xml?v=3af8817",
    ...
    "/posts/jupyter-publishing/?v=16074a1",
