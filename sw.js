const version = "752cf9d";
const currentCacheName = `ELCWEB-${version}`;
const filesToCache = [
    "/?v=8b506c6",
    "/about/?v=dc9d217",
    "/archives/?v=bd22db0",
    "/author/ezequiel-leonardo-castano/?v=b157d47",
    ...
    "/feeds/all-en.atom.xml?v=6377c17",
    "/feeds/all-es.atom.xml?v=1d8b0a5",
    "/feeds/all.atom.xml?v=5730c08",
    "/feeds/ezequiel-leonardo-castano.atom.xml?v=4d8dbad",
    ...
    "/posts/2021/?v=136f90b",
    "/posts/2021/Aug/?v=b51a5f8",
    ...
    "/posts/jupyter-publishing/?v=1cc72a5",
