...
const filesToCache = [
    ...
    "/jupyter-map/?v=be66a7c",
    "/jupyter-map/mapbox.js?v=7135eb5",
    "/jupyter-map/media_image.png?v=53ada72",
    "/jupyter-map/style.css?v=5a4a71e",
    ...
    "/lyrics-presentation/?v=f11ba44",
    "/lyrics-presentation/README.md?v=4899162",
    "/lyrics-presentation/lang.ini?v=13dec4f",
    "/lyrics-presentation/media_image.png?v=9d962e8",
    "/lyrics-presentation/pptx.js?v=b8493d4",
    "/lyrics-presentation/webl10n.min.js?v=3b3df9b",
    "/page/2/?v=a49dba7",
    ...
    "/sitemap.xml?v=c27bd88",
    "/tabubiblico/?v=3a948b5",
    "/tabubiblico/android-chrome-192x192.png?v=f817c34",
    "/tabubiblico/android-chrome-384x384.png?v=5760c62",
    "/tabubiblico/apple-touch-icon.png?v=10da135",
    "/tabubiblico/browserconfig.xml?v=caa5025",
    "/tabubiblico/css/app.546a4c6b.css?v=31dfda4",
    "/tabubiblico/favicon-16x16.png?v=789a4b4",
    "/tabubiblico/favicon-32x32.png?v=8bb2e2b",
    "/tabubiblico/favicon.ico?v=c84c78c",
    ...
    "/tabubiblico/js/app.e7467e6d.js.map?v=f2ca144",
    "/tabubiblico/js/app.e7467e6d.js?v=4feb5e0",
    "/tabubiblico/js/chunk-vendors.2e61d9a7.js.map?v=2305900",
    "/tabubiblico/js/chunk-vendors.2e61d9a7.js?v=b26444d",
    "/tabubiblico/mstile-150x150.png?v=e0fbde3",
    "/tabubiblico/safari-pinned-tab.svg?v=197ff44",
    "/tabubiblico/site.webmanifest?v=aa33ede",
    "/tabubiblico/social.png?v=0ddb05e",
    "/tabubiblico/social_large.png?v=16adcb9",
    "/tag/bible/?v=ef46346",
