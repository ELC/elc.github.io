const version = "faf021c";
const currentCacheName = `ELCWEB-${version}`;
const filesToCache = [
    "/?v=99ce6cb",
    "/about/?v=dc9d217",
    "/archives/?v=bd22db0",
    "/author/ezequiel-leonardo-castano/?v=8ff8762",
    ...
    "/category/programming/?v=89ec596",
    ...
    "/feeds/all-en.atom.xml?v=00f72ac",
    "/feeds/all-es.atom.xml?v=1d8b0a5",
    "/feeds/all.atom.xml?v=9630d66",
    "/feeds/ezequiel-leonardo-castano.atom.xml?v=fa6d1e4",
    "/feeds/ezequiel-leonardo-castano.rss.xml?v=28dd46c",
    ...
    "/posts/jupyter-publishing/?v=6be2ac9",
