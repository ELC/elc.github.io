...
const filesToCache = [
    ...
    "/drafts/bayesian-roadmap.html?v=ef3a89c",
    "/drafts/my-super-post2.html?v=315787f",
    "/drafts/pelican-mega-tutorial-part-1.html?v=f1e7db3",
    "/drafts/probability-world.html?v=e4fa6ce",
    "/extra/browserconfig.xml?v=8dbb903",
    "/extra/sw_template.js?v=4cee959",
    "/favicon.ico?v=b758f8a",
    "/feeds/all-en.atom.xml?v=59d977c",
    "/feeds/all-es.atom.xml?v=bea6e2c",
    "/feeds/all.atom.xml?v=43a0b25",
    "/feeds/ezequiel-leonardo-castano.atom.xml?v=49166c9",
    ...
    "/posts/embed-interactive-notebooks/?v=f4ea845",
    "/posts/executable-flask-pyinstaller/?v=89d23c8",
    "/posts/fastai-colab-deep-learning/?v=3367f72",
    "/posts/git-guide-with-visual-interface/?v=284a2e6",
    "/posts/git-guide-with-visual-interface/es/?v=4ea45bf",
    "/posts/haskell-pattern-matching-in-python/?v=9c0c12c",
    "/posts/juegos-biblicos/es/?v=14467ed",
    "/posts/jupyter-collaborative/?v=dd3ff34",
    "/posts/jupyter-publishing/?v=39ee765",
    "/posts/multi-floor-elevator-simulation-anylogic/?v=ee4ac3f",
    "/posts/online-lyrics-presentation-generator/?v=0bcaa3b",
    "/posts/online-lyrics-presentation-generator/es/?v=12b7f7b",
    "/posts/ordinary-differential-equations-with-python/?v=ee9c3bb",
    "/posts/pascal-triangle-vs-genetic-algorithm/?v=63b915f",
    "/posts/plotting-fractals-step-by-step-with-python/?v=017e002",
    "/posts/plotting-fractals-step-by-step-with-python/es/?v=eb9dfa2",
    "/posts/recursion-python/?v=a41d7dc",
    "/posts/streamlit-google-analytics/?v=61f50ea",
    "/posts/streamlit-lessons/?v=14b0c39",
    "/posts/streamlit-multipage/?v=d425305",
    "/posts/times-tables/?v=9116923",
    "/projects/?v=f9a673e",
