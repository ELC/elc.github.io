const version = "0b4a2e6";
const currentCacheName = `ELCWEB-${version}`;
const filesToCache = [
    "/?v=276b921",
    "/about/?v=0a6b4aa",
    "/archives/?v=4f11d5b",
    "/author/ezequiel-leonardo-castano/?v=95d868f",
    ...
    "/feeds/all-en.atom.xml?v=43b7912",
    "/feeds/all-es.atom.xml?v=1284f61",
    "/feeds/all.atom.xml?v=e1e5fb0",
    "/feeds/ezequiel-leonardo-castano.atom.xml?v=a77e930",
    "/feeds/ezequiel-leonardo-castano.rss.xml?v=258a8e3",
    ...
    "/posts/embed-interactive-notebooks/?v=2916ab3",
    "/posts/executable-flask-pyinstaller/?v=b264580",
    "/posts/fastai-colab-deep-learning/?v=45ac728",
    "/posts/git-guide-with-visual-interface/?v=1276469",
    "/posts/git-guide-with-visual-interface/es/?v=43b3b0c",
    "/posts/haskell-pattern-matching-in-python/?v=acb547a",
    ...
    "/posts/plotting-fractals-step-by-step-with-python/?v=f291f6a",
    "/posts/plotting-fractals-step-by-step-with-python/es/?v=ee2bc1c",
