...
const filesToCache = [
    ...
    "/feeds/all-en.atom.xml?v=1dd9818",
    "/feeds/all-es.atom.xml?v=1d8b0a5",
    "/feeds/all.atom.xml?v=84ed175",
    "/feeds/ezequiel-leonardo-castano.atom.xml?v=e4871b1",
    ...
    "/posts/jupyter-publishing/?v=8947d58",
