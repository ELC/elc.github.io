const version = "ad04b39";
const currentCacheName = `ELCWEB-${version}`;
const filesToCache = [
    "/?v=84b58da",
    "/about/?v=f08717c",
    "/archives/?v=7d3dd3b",
    "/author/ezequiel-leonardo-castano/?v=8fb1405",
    ...
    "/category/programming/?v=2c522cc",
    ...
    "/posts/jupyter-publishing/?v=522c9f4",
